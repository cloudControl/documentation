...
The recommended way to provide your AWS credentials to your app is via environment variables. To do this, use the [Config Add-on](/Add-on Documentation/Deployment/Custom Config.md):
