 ...
 * `http://APP_NAME.cloudcontrolled.com/` for the production deployment
 * `http://development-APP_NAME.cloudcontrolled.com/` for the development deployment
...
After deploying you can review the changes at `http://development-APP_NAME.cloudcontrolled.com/Check`. Make sure that everything is working.
...
~~~
Check the results at `http://APP_NAME.cloudcontrolled.com/Check`.
