...
However, a number of PHP frameworks, including Kohana, are auto-detected and the stack handling some of the deployment work for us, such as clearing/creating the cache directory.
