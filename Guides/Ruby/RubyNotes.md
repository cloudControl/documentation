...
~~~
dcapp APP_NAME/DEPLOYMENT config.add RACK_ENV=some_env RAILS_ENV=some_env
~~~
...
[procfile]: https://next.dotcloud.com/dev-center/platform-documentation#version-control--images
